...
const SUITES = [
    ...
    'photos_test', 'migration_test', 'history_scan_test', 'validation_test', 'datacheck_test', 'damagephotos_test', 'mobile_test', 'window_test', 'backup_test', 'keyboard_test', 'leave_test', 'regress'
];
